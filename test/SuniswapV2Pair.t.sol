...
import "../src/SuniswapV2Pair.sol";
import "./mocks/ERC20Mintable.sol";

contract SuniswapV2PairTest is Test {
    ...
    function setUp() public {
        ...
        pair = new SuniswapV2Pair(address(token0), address(token1));
...
contract TestUser {
    function provideLiquidity(
        ...
        SuniswapV2Pair(pairAddress_).mint();
    }

    function withdrawLiquidity(address pairAddress_) public {
        SuniswapV2Pair(pairAddress_).burn();
    }
}
